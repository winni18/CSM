...
class JerichoEnv:
    ...
    def __init__(self,
        ...
        self.filter_drop_acts = 0 # args.filter_drop_acts
        self.args = args
    ...
    def step(self, action):
        ...
        if not done:
            ...
            if self.cache is not None and hash_save in self.cache:
                ...
                true_valid = self.env.get_valid_actions()
                if len(true_valid) == 0:
                    true_valid = ['wait', 'yes', 'no']
                info['true_valid'] = true_valid
